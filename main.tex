...
\begin{abstract}
Reducing health inequalities requires improved understanding of the causes of variation. Local-level variation is likely to be partly due to differences in local population characteristics and partly due to differences in health system performance. Identifying low- and high-performing local areas allows investigation of the reasons for variations in performance.
We used multilevel regression with post-stratification (MRP) to synthesise multiple data sources, using chlamydia testing as our example. We used national-level survey data to identify individual-level characteristics associated with chlamydia testing and combined this with local-level demographic data to calculate expected levels of testing in each local authority (LA) in England, allowing us to identify LAs where observed chlamydia testing rates were lower or higher than expected, given population characteristics.
Using multiple covariates, including age, sex, ethnicity, student and co-habiting status, 5.4\% and 3.5\% of LAs had testing rates higher than expected for 95\% and 99\% posterior credible intervals, respectively; 60.9\% and 50.8\% had rates lower than expected. The residual difference between observed and MRP expected values was smallest for LAs with large proportions of non-white ethnic populations. London boroughs that were markedly different from the MRP expected values ($>$90\% posterior exceedance probability) were those which have actively targeted risk groups.
This type of synthesis approach allows more refined inferences to be made about health indicators at small-area levels not previously feasible otherwise.
